package sms.impl.external.smsgh;
...
import static sms.impl.external.smsgh.RequestHandler.UTF8;
...
public abstract class AbstractHttpClient {
     ...
     * @param path
     * @param params
     * @return contract.Response object
     */
     ...
     *
     * @param httpRequest
     * @return contract.Response object (may be null if request did not complete)
     */
